 ...
 */
@WebServlet("/LockMarkExamController")
public class LockMarkExamController extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public LockMarkExamController() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String data = new String(request.getParameter("submissionId").getBytes("ISO-8859-1"), "UTF-8");
		...
		if (user == null) {
			...
			if(islock)
				msg = lock.acquireLock(submissionId, "submissions", token);
			else {
				lock.releaseLock(submissionId, "submissions", token);
				msg = "true";
			}
		}
